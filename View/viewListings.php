    ...
    <main class="main-container">
        <div class="content-card">
            <div class="card-header">
                <div>
                    <h1 class="title-text">Room & Property Listings</h1>
                </div>
            ...
            <div class="table-responsive">
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>#L-301</td>
                            <td>Master Bed with Balcony, Dhanmondi</td>
                            <td>Rakibul Hasan</td>
                            <td>৳ 12,000</td>
                            <td>Single Room</td>
                        ...
                        <tr>
                            <td>#L-302</td>
                            <td>Attached Bath Studio, Mirpur-10</td>
                            <td>Tariqul Islam</td>
                            <td>৳ 8,500</td>
                            <td>Studio Flat</td>
                        ...
                        <tr>
                            <td>#L-303</td>
                            <td>Furnished 2 Bed Apartment, Uttara</td>
                            <td>Rakibul Hasan</td>
                            <td>৳ 22,000</td>
